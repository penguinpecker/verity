...
/// String/bytes conversion helpers used to reconstruct the exact message an
/// attestor signs, so signatures can be recovered on-chain. Matches the
/// serialization used by the attestor (Reclaim-compatible).
library StringUtils {
